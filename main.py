...
class VQADataset(torch.utils.data.Dataset):
    def __init__(self, df_path, image_dir, transform=None, answer=True):
        ...
        self.question2idx = glove_vectors.stoi
        self.idx2question = glove_vectors.itos
    ...
    def __getitem__(self, idx):
        ...
        question = np.zeros(len(self.question2idx) + 1)
...
def collate_fn(batch):
    ...
    answers = torch.nn.utils.rnn.pad_sequence(answers, batch_first=True)
